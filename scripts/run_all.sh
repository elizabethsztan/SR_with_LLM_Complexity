...
export LLAMAFILE_MODEL="Qwen2.5-0.5B-Instruct-Q4_K_M"
...
LLAMAFILE_PATH="llamafiles/Qwen2.5-0.5B-Instruct-Q4_K_M.llamafile"
...
# Run the simple expression test
echo "=================================="
echo "Running Simple Expression Test"
echo "=================================="
julia --project=. --threads=auto src/test_simple_expression.jl
TEST1_EXIT=$?
if [ $TEST1_EXIT -ne 0 ]; then
    echo "WARNING: Simple expression test failed with exit code $TEST1_EXIT"
fi

echo ""
echo "=================================="
echo "Running Complex Expression Test"
echo "=================================="
julia --project=. --threads=auto src/test_complex_expression.jl
TEST2_EXIT=$?
if [ $TEST2_EXIT -ne 0 ]; then
    echo "WARNING: Complex expression test failed with exit code $TEST2_EXIT"
fi
...
echo "=================================="
find experimental_results -type f -name "*.json" -exec ls -lh {} \; 2>/dev/null || echo "No result files found"
